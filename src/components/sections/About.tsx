export default function About() {
  return (
    <section id="sobre" className="w-full h-auto sm:h-screen px-[4vw] py-[60px] sm:py-[24px] flex flex-col justify-center">
      <h2 className="font-mono text-primary text-2xl sm:text-2xl font-bold pb-[68px]">
        /* SOBRE MIM */
      </h2>
      <article className="flex flex-col items-start">
        ...
        <button className="w-[140px] h-[50px] rounded-[30px] border-none bg-linear-to-br from-background-start to-background-end hover:translate-y-[-5%] transition-transform duration-500 ease-out">
          <a
            ...
            className="flex items-center justify-center w-full h-full text-primary text-[16px] hover:font-medium transition-all"
          >
            CURRÍCULO
          </a>
        </button>
